...
class Checkrequest extends StatelessWidget {
  ...
  Checkrequest({ required this.setRequestState, required this.setPolyLine,  }) ;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('DESTINATION', style: TextStyle(color: Colors.blue[800], fontWeight: FontWeight.bold)  ,),
              SizedBox(
                width: 6,
              ),
              Text('|', style: TextStyle(color: Colors.yellow[800], fontWeight: FontWeight.bold)  ,),
              SizedBox(
                width: 6,
              ),
              Text('ROUTE ', style: TextStyle(color: Colors.purple[800], fontWeight: FontWeight.bold)  ,),
            ],
          ),
          Divider(
            thickness: 2,
