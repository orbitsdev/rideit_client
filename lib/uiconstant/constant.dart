...
Color COLOR_PURPLE_BUTTON = HexColor("#8e44ad"); 
Color COLOR_SECONDARY_WHITE = HexColor("#FAFAFA"); 
...
const TextTheme TEXT_THEME_DEFAULT  =  TextTheme(
  ...
  bodyText2: TextStyle(color:COLOR_GEY, fontWeight: FontWeight.w500, fontSize: 14 , height: 1.5 ),
